import { data, dataLength, dataKeys, datavalues,test,megaFilter } from "./app.js";
const computersHolder = document.getElementById("computersHolder");
...
(() => {
  ...
  computersHolder.innerHTML = card;
})();
